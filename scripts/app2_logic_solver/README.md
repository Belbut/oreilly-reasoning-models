...
A Streamlit application that solves logic puzzles using OpenAI's GPT-5.6 with reasoning effort (low vs high) and visible chain-of-thought reasoning.
...
This app uses:
- **GPT-5.6**: For puzzle solving with reasoning effort (adjustable low/medium/high)
